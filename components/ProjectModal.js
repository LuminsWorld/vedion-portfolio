      ...
      >
        ...
        <div style={{ flex: 1, overflow: 'hidden', display: 'flex', flexDirection: bodyDirection, position: 'relative', zIndex: 2, minHeight: 0 }}>
          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: isMobile ? '1rem' : '1.5rem', display: 'flex', flexDirection: 'column', gap: '1rem', minHeight: 0 }}>
            ...
            {project.link && (
              <a href={project.link} target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '0.5rem', fontFamily: 'JetBrains Mono', fontSize: '11px', letterSpacing: '0.15em', color: project.colorHex, border: `1px solid ${project.colorHex}55`, padding: '0.5rem 1rem', borderRadius: '4px', textDecoration: 'none', transition: 'all 0.15s', width: 'fit-content' }}>
            ...
            {!project.isPlaceholder && !project.link && (
